    ...
    return (
        <div className="w-full bg-slate-400 h-screen flex justify-center items-center">
            <form action={formAction} method="post" className="w-80">
                ...
                <div className="text-left mt-10 p-2 border text-wrap">
...
function SubmitLoading() {
    ...
    return (
        <button disabled={pending} className="bg-black text-center w-full h-12 mt-4 rounded-sm text-white text-2xl">
